...
void __conhash_add_replicas(struct conhash_s *conhash, 
                            struct node_s *node) {
  u_int i, len;
  long hash;
  char buff[128];
...
void __conhash_del_replicas(struct conhash_s *conhash, 
                            struct node_s *node) {
  u_int i, len;
  long hash;
  char buff[128];
...
util_rbtree_node_t *__conhash_get_rbnode(struct node_s *node, 
                                         long hash) {
