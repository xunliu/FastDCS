...
//
#ifndef FASTDCS_BASE_CONFIG_BST_H_
#define FASTDCS_BASE_CONFIG_BST_H_
...
// Table functions.
struct bst_table *
bst_create (bst_comparison_func *, void *, struct libavl_allocator *);

struct bst_table *
bst_copy (const struct bst_table *, bst_copy_func *, bst_item_func *, struct libavl_allocator *);
...
#endif  // FASTDCS_BASE_CONFIG_BST_H_
